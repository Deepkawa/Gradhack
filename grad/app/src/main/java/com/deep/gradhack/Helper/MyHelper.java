package com.deep.gradhack.Helper;
...
public class MyHelper {
    ...
    public static File createTempFile(File file) {
        File dir = new File(Environment.getExternalStorageDirectory().getPath() + "/com.deep.gradhack");
    ...
    public static void needPermission(final AppCompatActivity activity, final int requestCode, int msg) {
